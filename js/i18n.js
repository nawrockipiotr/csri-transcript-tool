...
const I18N = {
  ...
  en: {
    ...
    demo_guide_banner: 'Demo mode — sample results shown below. Upload your own transcript files to get real analysis.',
    demo_guide_summary: 'Structured summary of the transcript: context, main topics, key findings, and ambiguities. Helps with quick orientation before detailed reading.',
    demo_guide_translation: 'Translated transcript with three views: plain Translation, Side-by-side (original + translation), and Inline diff. Flag markers (« ») carry over quality issues from the original.',
    demo_guide_quality: 'Transcript quality assessment. Yellow flags = minor ASR errors (garbled but guessable). Red flags = serious issues (incomprehensible). Click any flag to correct it inline.',
    demo_guide_speaker: 'Speaker label verification: declared vs. estimated count, label coverage percentage, and consistency check.',
    demo_guide_anon: 'Detected PII (names, organizations, dates) with color-coded tags. Export as Redacted (tags → placeholders) or Marked (tags visible for review).',
    demo_guide_stats: 'Transcript statistics: word/character counts, speaker turns, and per-speaker word distribution.',
    // File System target
  ...
  pl: {
    ...
    demo_pl: 'Wywiad PL',
    demo_en: 'Wywiad EN',
    demo_guide_banner: 'Tryb demo — poniżej przykładowe wyniki. Wgraj własne pliki transkrypcji, aby uzyskać analizę.',
    demo_guide_summary: 'Podsumowanie transkrypcji: kontekst, główne tematy, kluczowe ustalenia i niejednoznaczności. Ułatwia orientację przed szczegółową lekturą.',
    demo_guide_translation: 'Przetłumaczona transkrypcja w trzech widokach: Tłumaczenie, Obok siebie (oryginał + tłumaczenie) i Diff inline. Znaczniki (« ») przenoszą problemy jakościowe z oryginału.',
    demo_guide_quality: 'Ocena jakości transkrypcji. Żółte flagi = drobne błędy ASR (zniekształcone, ale zrozumiałe). Czerwone = poważne (niezrozumiałe). Kliknij flagę, aby poprawić inline.',
    demo_guide_speaker: 'Weryfikacja etykiet mówców: zadeklarowana vs. oszacowana liczba, pokrycie etykiet i spójność.',
    demo_guide_anon: 'Wykryte dane osobowe (imiona, organizacje, daty) z kolorowymi tagami. Eksport: Zredagowany (tagi → placeholdery) lub Oznaczony (tagi widoczne do przeglądu).',
    demo_guide_stats: 'Statystyki transkrypcji: liczba słów/znaków, tury mówców i rozkład słów na mówcę.',
    // File System target
